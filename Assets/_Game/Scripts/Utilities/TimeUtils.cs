...
namespace DL.Utils
{
    public static class TimeUtils
    {
        ...
        public static string SecondsToHMS(int totalSecs)
        {
            ...
            var secString = seconds > 9 ? seconds.ToString() : "0" + seconds.ToString();
        ...
        public static int GetCurrentTimeInSeconds()
        {
            ...
            double seconds = currentTime.Hour * 3600 + currentTime.Minute * 60 + currentTime.Second + currentTime.Millisecond / 1000.0;

            return (int)seconds;
        }
        public static int GetDayOfWeekIndexInMonth(int dayInMonth)
        {
            DateTime currentDate = DateTime.Now;
            DateTime inputDate = new DateTime(currentDate.Year, currentDate.Month, dayInMonth);

            int dayOfWeekIndex = (int)inputDate.DayOfWeek;
            if (dayOfWeekIndex == 0)
            {
                dayOfWeekIndex = 6;
            }
